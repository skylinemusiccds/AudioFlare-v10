    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btGithub.setOnClickListener {
            val urlIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/UniVerse-devops/audioflare")
            )
        ...
        binding.btIssue.setOnClickListener {
            val urlIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/UniVerse-devops/audioflare/issues")
            )
            startActivity(urlIntent)
        }
        binding.btBuyMeACoffee.setOnClickListener {
            val urlIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://www.buymeacoffee.com/universe")
            )
            startActivity(urlIntent)
        }
